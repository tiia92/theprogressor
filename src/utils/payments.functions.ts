...
/** Creates an embedded checkout session for a Pro plan. Requires a signed-in reader. */
...
/** Opens the Stripe billing portal so readers can cancel or update payment details. */
