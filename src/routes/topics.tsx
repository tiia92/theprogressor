...
function TopicsIndex() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <h1 className="mt-2 font-heading text-4xl text-foreground md:text-5xl">Topics</h1>
      ...
      <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {TOPICS.map((t) => (
          ...
          >
            <p className="font-heading text-lg text-foreground group-hover:text-primary">
              {t.label}
            </p>
