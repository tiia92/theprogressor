...
export const Route = createFileRoute("/article/$slug")({
  ...
  notFoundComponent: () => (
    <div className="mx-auto max-w-2xl px-4 py-16 text-center">
      <h1 className="font-heading text-3xl text-foreground">Article not found</h1>
  ...
  return (
    <article>
      {article.hero_image_url ? (
        <div className="relative">
          ...
          <div className="relative mx-auto max-w-3xl px-4 py-14 md:py-20">
            ...
            <p className="mt-4 font-heading text-xl italic leading-snug text-white/90 md:text-2xl">
              {article.dek}
            </p>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        {!article.hero_image_url && (
          <>
            <h1 className="font-heading text-3xl leading-tight text-foreground md:text-5xl">
              {article.title}
            </h1>
            <p className="mt-4 font-heading text-xl italic leading-snug text-muted-foreground md:text-2xl">
              {article.dek}
            </p>
          </>
        )}
