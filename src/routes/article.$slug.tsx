...
export const Route = createFileRoute("/article/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        { title: `${loaderData.title} — NewSlop` },
    ...
    <article>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="my-6 flex items-center gap-3 border-y border-border py-3 text-xs text-muted-foreground">
          <span className="font-mono uppercase tracking-[0.14em]">By NewSlop AI Editor</span>
          <span>·</span>
        ...
        <div className="mt-12 rounded-lg border border-border bg-muted/40 p-6 text-sm text-muted-foreground">
          <p className="font-serif text-base text-foreground">
            Every article on NewSlop is generated by an AI editor.
          </p>
          <p className="mt-2">
